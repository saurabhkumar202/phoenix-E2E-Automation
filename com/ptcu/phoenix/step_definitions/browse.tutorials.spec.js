...
const browse_tutorials_page_1 = require("../pages/browse.tutorials.page");
...
function browsespecs() {
    var tutorialsLandingPageObj = new tutorials_landing_page_1.tutorialsLandingPage();
    var browserTutorialPageObj = new browse_tutorials_page_1.browseTutorialsPage();
    this.Given(/^I go to PTCU site$/, () => {
        protractor_1.browser.get(protractor_1.browser.params.URLOptions.iotuURL);
    });
    this.When(/^I browse tutorials tab$/, () => {
        protractor_1.browser.waitForAngular();
        tutorialsLandingPageObj.goToTutorials();
    });
    this.Then(/^I see the tutorials home page$/, () => {
        tutorialsLandingPageObj.getURL().then((currentURL) => {
            expect(currentURL).to.contain('tutorials');
        });
    });
    this.When(/^I browse tutorials by product family$/, () => {
    ...
    this.When(/^I browse tutorials by product name$/, () => {
        protractor_1.browser.waitForAngular();
    ...
    this.Then(/^I browse tutorials by product release$/, () => {
